 ...
 ****************************LAYER: HAL *****************************
 *************************MODULE: IRSensor***************************
 *********************FILE Name: IR_Program.h************************
 *DESCRIPTION: Implementation of IR-Sensor Main Functions sourceFile*
 ************************UPDATED: 3/11/2023**************************
 *************************AUTHOR: HEX CLAN***************************
 ********************************************************************
*/
...
//Initiallization of Error State = Not Ok (1)
	...
	if(Pin_Config.Port_Id <= PORTD_ID){
		MCAL_DIO_u8_Init_Direction(Pin_Config.Port_Id , Pin_Config.Pin_Id , Pin_Config.dir);
		Local_u8_ErrorStatus = OK;
	}
